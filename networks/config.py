...
_C.DATA.DATA_PATH = ''
# Dataset name
_C.DATA.DATASET = 'lung_cancer'
# Input image size
_C.DATA.IMG_SIZE = 896
...
_C.MODEL.PRETRAIN_CKPT = './checkpoint/pretrained/swinUnet/model_best.pth' # '../pretrained/swin_tiny_patch4_window7_224.pth'
_C.MODEL.RESUME = ''
